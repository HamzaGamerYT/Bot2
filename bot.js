...
client.on("message", message => {
 if (message.content === "*invite") {
  const embed = new Discord.RichEmbed()
      ...
      .addField('شكرا لك لاستخدامك ل بروميوم بوت', `https://discordapp.com/api/oauth2/authorize?client_id=535468009100410883&permissions=2146958839&scope=bot`)
...
client.on("message", message => {
 if (message.content === "*support") {
  const embed = new Discord.RichEmbed()
      ...
      .addField('سيرفر الدعم الفني', `  https://discord.gg/DxBwS2J  `)
  message.author.send({embed});
...
const TOKEN = "NTM2ODU4MjExNjM5MjMwNDc0.Dyc_DQ.tsVaQ2RRL8DufDZrs9iEhh-Yf5k";
...
client.login("NTM2ODU4MjExNjM5MjMwNDc0.Dyc_DQ.tsVaQ2RRL8DufDZrs9iEhh-Yf5k");